package com.videojj.videopublicapi;
 ...
 * @Author @videopls.com
 * Created by  on 2018/7/24 下午4:48.
 * @Description:
 */
//@ComponentScan(basePackages = {"com.videojj.*"})
@ComponentScan(basePackageClasses = {VideoPublicAppliApplication.class,
        VideoServiceApplication.class})
@SpringBootApplication
//@MapperScan({"com.videojj.videoservice.dao"})
public class VideoPublicAppliApplication {

    public static void main(String[] args) {
        SpringApplication.run(VideoPublicAppliApplication.class, args);
    }
}
